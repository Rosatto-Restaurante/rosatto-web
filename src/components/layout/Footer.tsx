  ...
  return (
    <footer className="bg-dl-dark text-dl-cream">
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        {/* Columna 1: Contacto */}
        <div>
          <h4 className="font-sans tracking-wide2 uppercase text-dl-magenta text-lg mb-3 reveal-title-simple">Sede Costa Azul</h4>
          <ul className="space-y-2 text-sm opacity-90 reveal-text">
        ...
        {/* Columna 2 */}
        <div>
          <h4 className="font-sans tracking-wide2 uppercase text-dl-magenta text-lg mb-3 reveal-title-simple">Sede Diamante</h4>
          <ul className="space-y-2 text-sm opacity-90 reveal-text">
            <li>Próximamente…</li>
          </ul>
        </div>
        ...
        <div>
          <h4 className="font-sans tracking-wide2 uppercase text-dl-magenta text-lg mb-3 reveal-title-simple">Social</h4>
          <ul className="space-y-2 text-sm opacity-90 mb-6 reveal-text">
            <li>
              <a 
          ...
          <h4 className="font-sans tracking-wide2 uppercase text-dl-magenta text-lg mb-3 reveal-title-simple">Opiniones</h4>
          <ul className="space-y-2 text-sm opacity-90 reveal-text">
            <li>
              <a 
      ...
      <div className="border-t border-white/10 py-6 text-center text-xs opacity-70 space-y-2 reveal-text">
